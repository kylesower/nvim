...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["starry.nvim"] = {
    loaded = true,
    needs_bufread = false,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/opt/starry.nvim",
  ...
  undotree = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-visual-multi"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/vim-visual-multi",
...
try_loadstring("\27LJ\2\n8\0\0\2\0\3\0\0056\0\0\0009\0\1\0+\1\1\0=\1\2\0K\0\1\0\27starry_italic_comments\6g\bvim\0", "setup", "starry.nvim")
